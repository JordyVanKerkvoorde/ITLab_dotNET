...
//        {
//            User testUsr = new User(Id, FName, LName, UserType.ADMIN, UserStatus.ACTIVE);
...
//            Assert.Throws<ArgumentNullException>(() => new User(Id, FName, LName, UserType.ADMIN, UserStatus.ACTIVE));
//        }
//    }
//}
