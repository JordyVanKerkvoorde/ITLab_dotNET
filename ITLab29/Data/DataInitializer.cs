    ...
    public class DataInitializer
    {
        ...
        public async Task InitializeData()
        {
            ...
            if(_dbContext.Database.EnsureCreated())
            {
                ...
                Guest guest1 = new Guest(0, "De heer Meneer", "deheermeneer@mail.com", "0412 12 12 12");
                Guest guest2 = new Guest(1, "De heer Mevrouw", "deheermevrouw@mail.com", "0413 13 13 13");
                Guest guest3 = new Guest(2, "De heer Madame", "deheermadame@mail.com", "0414 14 14 14");
